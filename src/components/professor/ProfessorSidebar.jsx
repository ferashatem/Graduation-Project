...
function ProfessorSidebar({ open = false, onClose, onNavigate, profile, user }) {
  ...
  return (
    <>
      <aside
        className={`fixed top-0 left-0 z-40 flex h-screen w-64 max-w-[80vw] flex-col bg-gradient-to-b from-[#f7f1e6] via-[#edf4ff] to-[#c7d7ff] shadow-2xl ring-1 ring-white/60 transition-transform duration-300 ipad-landscape:static ipad-landscape:translate-x-0 ${
