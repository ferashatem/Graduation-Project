  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className={`text-sm font-medium truncate ${active ? "text-violet-700" : "text-slate-700"}`}>{title}</p>
        {timeLabel && (
      ...
      {hovered && (
        <button
          ...
          className="shrink-0 p-1 rounded-md text-slate-400 hover:text-red-500 hover:bg-red-50 transition"
        >
        ...
        <div className="flex items-end gap-1.5 max-w-[75%]">
          {hovered && (
            <button
              ...
              className="p-1 rounded-md text-slate-400 hover:text-red-500 hover:bg-red-50 transition mb-1"
            >
              <HiOutlineTrash className="h-3.5 w-3.5" />
            </button>
          )}
      ...
      <div className="flex-1 min-w-0 pt-1">
        ...
        {hovered && (
          <button
            type="button"
            onClick={() => onDelete?.(msg.id)}
            className="mt-2 p-1 rounded-md text-slate-400 hover:text-red-500 hover:bg-red-50 transition"
          >
            <HiOutlineTrash className="h-3.5 w-3.5" />
          </button>
        )}
...
export default function ChatPage() {
  ...
  return (
    <div className={`h-full ${dark ? "dark" : ""}`}>
      <div className="flex h-full overflow-hidden bg-white rounded-2xl shadow-sm ring-1 ring-slate-100">

        {/* ── Chats sidebar ── */}
        <aside
          className={`flex flex-col border-r border-slate-100 bg-white transition-all duration-200 ${
        ...
        >
          ...
          <div className="px-3 py-3">
            <button
              type="button"
              onClick={startNewConversation}
              className="w-full flex items-center gap-2 px-3 py-2 rounded-xl border border-dashed border-slate-200 text-sm text-slate-500 hover:border-violet-300 hover:text-violet-600 hover:bg-violet-50 transition"
            >
          ...
          {/* Chats list */}
          <p className="px-4 pb-1 text-[11px] font-bold uppercase tracking-widest text-slate-400">Chats</p>
        ...
        <div className="flex flex-1 flex-col min-w-0 bg-white">
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-100 shrink-0">
            ...
            <p className="text-base font-bold text-slate-800">AI Assistant</p>
            ...
            <div className="mx-auto max-w-3xl px-5 py-6 space-y-6">
              {loadingMsgs ? (
                ...
                <div className="flex flex-col items-center text-center pt-10">
                  <AIRobotIcon />
                  <h2 className="text-2xl font-bold text-slate-800 mt-2">How can I help you today?</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {SUGGESTED.map((q) => (
                        <button
                          ...
                          className="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-600 hover:border-violet-300 hover:bg-violet-50 hover:text-violet-700 transition text-left"
                        >
              ...
              {error && (
                <p className="text-center text-xs text-red-500 bg-red-50 rounded-xl px-3 py-2 ring-1 ring-red-100">
                  {error}
                </p>
              )}
              <div ref={bottomRef} />
            ...
            <div className="mx-auto max-w-3xl">
              {pendingConfirmation && (
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-sm text-slate-700 font-medium">تأكيد التنفيذ؟</span>
                  <button
                    type="button"
                  ...
                  <button
                    ...
                    disabled={sending}
                    className="flex items-center gap-1.5 rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 px-4 py-1.5 text-sm font-semibold transition disabled:opacity-50"
                  >
              ...
              <div className="flex items-end gap-2 bg-slate-50 rounded-2xl px-4 py-3 ring-1 ring-slate-200 focus-within:ring-violet-300 transition">
                {/* Sparkle icon */}
                ...
                <textarea
                  ...
                  className="flex-1 resize-none bg-transparent text-sm text-slate-800 placeholder-slate-400 outline-none max-h-[200px] overflow-y-auto py-1"
